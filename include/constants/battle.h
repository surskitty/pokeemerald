...
#define SIDE_STATUS_GOOD_COURT     (SIDE_STATUS_GOOD_FOG | SIDE_STATUS_TAILWIND | SIDE_STATUS_RAINBOW | SIDE_STATUS_LUCKY_CHANT)
#define SIDE_STATUS_BAD_COURT      (SIDE_STATUS_SEA_OF_FIRE | SIDE_STATUS_SWAMP)
// Bad Court leaves out hazards because it is for AI logic.
...
#define B_WEATHER_LOW_LIGHT     (B_WEATHER_RAIN | B_WEATHER_SANDSTORM | B_WEATHER_ICY_ANY | B_WEATHER_FOG)
#define B_WEATHER_PRIMAL_ANY    (B_WEATHER_RAIN_PRIMAL | B_WEATHER_SUN_PRIMAL | B_WEATHER_STRONG_WINDS)
#define B_WEATHER_DAMAGING      (B_WEATHER_HAIL | B_WEATHER_SANDSTORM)
