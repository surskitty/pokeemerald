...
const struct SpriteTemplate gSurfablePokemonOverlaySprites[] =
{
    ...
    {0xFFFF, PAL_TAG_PIKACHU_SURF,    &gObjectEventBaseOam_32x32, gSurfablePokemonAnimTable, gSurfingOverworldPicTable_Pikachu,    gDummySpriteAffineAnimTable, UpdateSurfMonOverlay},
    {0xFFFF, PAL_TAG_RAICHU_SURF,     &gObjectEventBaseOam_32x32, gSurfablePokemonAnimTable, gSurfingOverworldPicTable_Raichu,     gDummySpriteAffineAnimTable, UpdateSurfMonOverlay},
...
// Gen II Pokemon
    ...
    {0xFFFF, PAL_TAG_PICHU_SURF,      &gObjectEventBaseOam_32x32, gSurfablePokemonAnimTable, gSurfingOverworldPicTable_Pichu,      gDummySpriteAffineAnimTable, UpdateSurfMonOverlay},
