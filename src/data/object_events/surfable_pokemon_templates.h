...
const struct SpriteTemplate gSurfablePokemonOverworldSprites[] =
{
    ...
    {0xFFFF, PAL_TAG_GYARADOS_SURF,   &gObjectEventBaseOam_32x32, gSurfablePokemonAnimTable, gSurfingOverworldPicTable_Gyarados,   gDummySpriteAffineAnimTable, UpdateSurfBlobFieldEffect},
    ...
    {0xFFFF, PAL_TAG_DRAGONAIR_SURF,  &gObjectEventBaseOam_32x32, gSurfablePokemonAnimTable, gSurfingOverworldPicTable_Dragonair,  gDummySpriteAffineAnimTable, UpdateSurfBlobFieldEffect},
...
// Gen II Pokemon
    ...
    {0xFFFF, PAL_TAG_FERALIGATR_SURF, &gObjectEventBaseOam_32x32, gSurfablePokemonAnimTable, gSurfingOverworldPicTable_Feraligatr, gDummySpriteAffineAnimTable, UpdateSurfBlobFieldEffect},
    ...
    {0xFFFF, PAL_TAG_SNEASEL_SURF,    &gObjectEventBaseOam_32x32, gSurfablePokemonAnimTable, gSurfingOverworldPicTable_Sneasel,    gDummySpriteAffineAnimTable, UpdateSurfBlobFieldEffect},
...
{
    {0xFFFF, PAL_TAG_SQUIRTLE_SURF,   &gObjectEventBaseOam_32x32, gSurfablePokemonAnimTable, gSurfingOverworldPicTable_Squirtle,   gDummySpriteAffineAnimTable, UpdateSurfMonOverlay},
    {0xFFFF, PAL_TAG_WARTORTLE_SURF,  &gObjectEventBaseOam_32x32, gSurfablePokemonAnimTable, gSurfingOverworldPicTable_Wartortle,  gDummySpriteAffineAnimTable, UpdateSurfMonOverlay},
    {0xFFFF, PAL_TAG_BLASTOISE_SURF,  &gObjectEventBaseOam_32x32, gSurfablePokemonAnimTable, gSurfingOverworldPicTable_Blastoise,  gDummySpriteAffineAnimTable, UpdateSurfMonOverlay},
    {0xFFFF, PAL_TAG_NIDOQUEEN_SURF,  &gObjectEventBaseOam_32x32, gSurfablePokemonAnimTable, gSurfingOverworldPicTable_Nidoqueen,  gDummySpriteAffineAnimTable, UpdateSurfMonOverlay},
    {0xFFFF, PAL_TAG_NIDOKING_SURF,   &gObjectEventBaseOam_32x32, gSurfablePokemonAnimTable, gSurfingOverworldPicTable_Nidoking,   gDummySpriteAffineAnimTable, UpdateSurfMonOverlay},
    {0xFFFF, PAL_TAG_PSYDUCK_SURF,    &gObjectEventBaseOam_32x32, gSurfablePokemonAnimTable, gSurfingOverworldPicTable_Psyduck,    gDummySpriteAffineAnimTable, UpdateSurfMonOverlay},
    {0xFFFF, PAL_TAG_GOLDUCK_SURF,    &gObjectEventBaseOam_32x32, gSurfablePokemonAnimTable, gSurfingOverworldPicTable_Golduck,    gDummySpriteAffineAnimTable, UpdateSurfMonOverlay},
    {0xFFFF, PAL_TAG_POLIWAG_SURF,    &gObjectEventBaseOam_32x32, gSurfablePokemonAnimTable, gSurfingOverworldPicTable_Poliwag,    gDummySpriteAffineAnimTable, UpdateSurfMonOverlay},
    {0xFFFF, PAL_TAG_POLIWHIRL_SURF,  &gObjectEventBaseOam_32x32, gSurfablePokemonAnimTable, gSurfingOverworldPicTable_Poliwhirl,  gDummySpriteAffineAnimTable, UpdateSurfMonOverlay},
    {0xFFFF, PAL_TAG_POLIWRATH_SURF,  &gObjectEventBaseOam_32x32, gSurfablePokemonAnimTable, gSurfingOverworldPicTable_Poliwrath,  gDummySpriteAffineAnimTable, UpdateSurfMonOverlay},
    {0xFFFF, PAL_TAG_TENTACOOL_SURF,  &gObjectEventBaseOam_32x32, gSurfablePokemonAnimTable, gSurfingOverworldPicTable_Tentacool,  gDummySpriteAffineAnimTable, UpdateSurfMonOverlay},
    {0xFFFF, PAL_TAG_TENTACRUEL_SURF, &gObjectEventBaseOam_32x32, gSurfablePokemonAnimTable, gSurfingOverworldPicTable_Tentacruel, gDummySpriteAffineAnimTable, UpdateSurfMonOverlay},
    {0xFFFF, PAL_TAG_SLOWPOKE_SURF,   &gObjectEventBaseOam_32x32, gSurfablePokemonAnimTable, gSurfingOverworldPicTable_Slowpoke,   gDummySpriteAffineAnimTable, UpdateSurfMonOverlay},
    ...
    {0xFFFF, PAL_TAG_LICKTUNG_SURF,   &gObjectEventBaseOam_32x32, gSurfablePokemonAnimTable, gSurfingOverworldPicTable_Lickitung,  gDummySpriteAffineAnimTable, UpdateSurfMonOverlay},
    {0xFFFF, PAL_TAG_RHYDON_SURF,     &gObjectEventBaseOam_32x32, gSurfablePokemonAnimTable, gSurfingOverworldPicTable_Rhydon,     gDummySpriteAffineAnimTable, UpdateSurfMonOverlay},
    {0xFFFF, PAL_TAG_KANGASKHAN_SURF, &gObjectEventBaseOam_32x32, gSurfablePokemonAnimTable, gSurfingOverworldPicTable_Kangaskhan, gDummySpriteAffineAnimTable, UpdateSurfMonOverlay},
    {0xFFFF, PAL_TAG_HORSEA_SURF,     &gObjectEventBaseOam_32x32, gSurfablePokemonAnimTable, gSurfingOverworldPicTable_Horsea,     gDummySpriteAffineAnimTable, UpdateSurfMonOverlay},
    {0xFFFF, PAL_TAG_SEADRA_SURF,     &gObjectEventBaseOam_32x32, gSurfablePokemonAnimTable, gSurfingOverworldPicTable_Seadra,     gDummySpriteAffineAnimTable, UpdateSurfMonOverlay},
    {0xFFFF, PAL_TAG_GOLDEEN_SURF,    &gObjectEventBaseOam_32x32, gSurfablePokemonAnimTable, gSurfingOverworldPicTable_Goldeen,    gDummySpriteAffineAnimTable, UpdateSurfMonOverlay},
    {0xFFFF, PAL_TAG_SEAKING_SURF,    &gObjectEventBaseOam_32x32, gSurfablePokemonAnimTable, gSurfingOverworldPicTable_Seaking,    gDummySpriteAffineAnimTable, UpdateSurfMonOverlay},
    {0xFFFF, PAL_TAG_STARYU_SURF,     &gObjectEventBaseOam_32x32, gSurfablePokemonAnimTable, gSurfingOverworldPicTable_Staryu,     gDummySpriteAffineAnimTable, UpdateSurfMonOverlay},
    {0xFFFF, PAL_TAG_STARMIE_SURF,    &gObjectEventBaseOam_32x32, gSurfablePokemonAnimTable, gSurfingOverworldPicTable_Starmie,    gDummySpriteAffineAnimTable, UpdateSurfMonOverlay},
    {0xFFFF, PAL_TAG_TAUROS_SURF,     &gObjectEventBaseOam_32x32, gSurfablePokemonAnimTable, gSurfingOverworldPicTable_Tauros,     gDummySpriteAffineAnimTable, UpdateSurfMonOverlay},
    {0xFFFF, PAL_TAG_GYARADOS_SURF,   &gObjectEventBaseOam_32x32, gSurfablePokemonAnimTable, gSurfingOverworldPicTable_Gyarados,   gDummySpriteAffineAnimTable, UpdateSurfMonOverlay},
    ...
    {0xFFFF, PAL_TAG_VAPOREON_SURF,   &gObjectEventBaseOam_32x32, gSurfablePokemonAnimTable, gSurfingOverworldPicTable_Vaporeon,   gDummySpriteAffineAnimTable, UpdateSurfMonOverlay},
    {0xFFFF, PAL_TAG_OMANYTE_SURF,    &gObjectEventBaseOam_32x32, gSurfablePokemonAnimTable, gSurfingOverworldPicTable_Omanyte,    gDummySpriteAffineAnimTable, UpdateSurfMonOverlay},
    {0xFFFF, PAL_TAG_OMASTAR_SURF,    &gObjectEventBaseOam_32x32, gSurfablePokemonAnimTable, gSurfingOverworldPicTable_Omastar,    gDummySpriteAffineAnimTable, UpdateSurfMonOverlay},
    {0xFFFF, PAL_TAG_KABUTO_SURF,     &gObjectEventBaseOam_32x32, gSurfablePokemonAnimTable, gSurfingOverworldPicTable_Kabuto,     gDummySpriteAffineAnimTable, UpdateSurfMonOverlay},
    {0xFFFF, PAL_TAG_KABUTOPS_SURF,   &gObjectEventBaseOam_32x32, gSurfablePokemonAnimTable, gSurfingOverworldPicTable_Kabutops,   gDummySpriteAffineAnimTable, UpdateSurfMonOverlay},
    {0xFFFF, PAL_TAG_SNORLAX_SURF,    &gObjectEventBaseOam_32x32, gSurfablePokemonAnimTable, gSurfingOverworldPicTable_Snorlax,    gDummySpriteAffineAnimTable, UpdateSurfMonOverlay},
    {0xFFFF, PAL_TAG_DRATINI_SURF,    &gObjectEventBaseOam_32x32, gSurfablePokemonAnimTable, gSurfingOverworldPicTable_Dratini,    gDummySpriteAffineAnimTable, UpdateSurfMonOverlay},
    {0xFFFF, PAL_TAG_DRAGONAIR_SURF,  &gObjectEventBaseOam_32x32, gSurfablePokemonAnimTable, gSurfingOverworldPicTable_Dragonair,  gDummySpriteAffineAnimTable, UpdateSurfMonOverlay},
    {0xFFFF, PAL_TAG_DRAGONITE_SURF,  &gObjectEventBaseOam_32x32, gSurfablePokemonAnimTable, gSurfingOverworldPicTable_Dragonite,  gDummySpriteAffineAnimTable, UpdateSurfMonOverlay},
    {0xFFFF, PAL_TAG_MEW_SURF,        &gObjectEventBaseOam_32x32, gSurfablePokemonAnimTable, gSurfingOverworldPicTable_Mew,        gDummySpriteAffineAnimTable, UpdateSurfMonOverlay},
// Gen II Pokemon
    {0xFFFF, PAL_TAG_TOTODILE_SURF,   &gObjectEventBaseOam_32x32, gSurfablePokemonAnimTable, gSurfingOverworldPicTable_Totodile,   gDummySpriteAffineAnimTable, UpdateSurfMonOverlay},
    {0xFFFF, PAL_TAG_CROCONAW_SURF,   &gObjectEventBaseOam_32x32, gSurfablePokemonAnimTable, gSurfingOverworldPicTable_Croconaw,   gDummySpriteAffineAnimTable, UpdateSurfMonOverlay},
    {0xFFFF, PAL_TAG_FERALIGATR_SURF, &gObjectEventBaseOam_32x32, gSurfablePokemonAnimTable, gSurfingOverworldPicTable_Feraligatr, gDummySpriteAffineAnimTable, UpdateSurfMonOverlay},
    {0xFFFF, PAL_TAG_SENTRET_SURF,    &gObjectEventBaseOam_32x32, gSurfablePokemonAnimTable, gSurfingOverworldPicTable_Sentret,    gDummySpriteAffineAnimTable, UpdateSurfMonOverlay},
    {0xFFFF, PAL_TAG_FURRET_SURF,     &gObjectEventBaseOam_32x32, gSurfablePokemonAnimTable, gSurfingOverworldPicTable_Furret,     gDummySpriteAffineAnimTable, UpdateSurfMonOverlay},
    {0xFFFF, PAL_TAG_CHINCHOU_SURF,   &gObjectEventBaseOam_32x32, gSurfablePokemonAnimTable, gSurfingOverworldPicTable_Chinchou,   gDummySpriteAffineAnimTable, UpdateSurfMonOverlay},
    {0xFFFF, PAL_TAG_LANTURN_SURF,    &gObjectEventBaseOam_32x32, gSurfablePokemonAnimTable, gSurfingOverworldPicTable_Lanturn,    gDummySpriteAffineAnimTable, UpdateSurfMonOverlay},
    {0xFFFF, PAL_TAG_MARILL_SURF,     &gObjectEventBaseOam_32x32, gSurfablePokemonAnimTable, gSurfingOverworldPicTable_Marill,     gDummySpriteAffineAnimTable, UpdateSurfMonOverlay},
    {0xFFFF, PAL_TAG_AZUMARILL_SURF,  &gObjectEventBaseOam_32x32, gSurfablePokemonAnimTable, gSurfingOverworldPicTable_Azumarill,  gDummySpriteAffineAnimTable, UpdateSurfMonOverlay},
    {0xFFFF, PAL_TAG_POLITOED_SURF,   &gObjectEventBaseOam_32x32, gSurfablePokemonAnimTable, gSurfingOverworldPicTable_Politoed,   gDummySpriteAffineAnimTable, UpdateSurfMonOverlay},
    {0xFFFF, PAL_TAG_WOOPER_SURF,     &gObjectEventBaseOam_32x32, gSurfablePokemonAnimTable, gSurfingOverworldPicTable_Wooper,     gDummySpriteAffineAnimTable, UpdateSurfMonOverlay},
    {0xFFFF, PAL_TAG_QUAGSIRE_SURF,   &gObjectEventBaseOam_32x32, gSurfablePokemonAnimTable, gSurfingOverworldPicTable_Quagsire,   gDummySpriteAffineAnimTable, UpdateSurfMonOverlay},
    {0xFFFF, PAL_TAG_SLOWKING_SURF,   &gObjectEventBaseOam_32x32, gSurfablePokemonAnimTable, gSurfingOverworldPicTable_Slowking,   gDummySpriteAffineAnimTable, UpdateSurfMonOverlay},
    {0xFFFF, PAL_TAG_QWILFISH_SURF,   &gObjectEventBaseOam_32x32, gSurfablePokemonAnimTable, gSurfingOverworldPicTable_Qwilfish,   gDummySpriteAffineAnimTable, UpdateSurfMonOverlay},
    {0xFFFF, PAL_TAG_SNEASEL_SURF,    &gObjectEventBaseOam_32x32, gSurfablePokemonAnimTable, gSurfingOverworldPicTable_Sneasel,    gDummySpriteAffineAnimTable, UpdateSurfMonOverlay},
    {0xFFFF, PAL_TAG_CORSOLA_SURF,    &gObjectEventBaseOam_32x32, gSurfablePokemonAnimTable, gSurfingOverworldPicTable_Corsola,    gDummySpriteAffineAnimTable, UpdateSurfMonOverlay},
    {0xFFFF, PAL_TAG_REMORAID_SURF,   &gObjectEventBaseOam_32x32, gSurfablePokemonAnimTable, gSurfingOverworldPicTable_Remoraid,   gDummySpriteAffineAnimTable, UpdateSurfMonOverlay},
    {0xFFFF, PAL_TAG_OCTILLERY_SURF,  &gObjectEventBaseOam_32x32, gSurfablePokemonAnimTable, gSurfingOverworldPicTable_Octillery,  gDummySpriteAffineAnimTable, UpdateSurfMonOverlay},
    {0xFFFF, PAL_TAG_MANTINE_SURF,    &gObjectEventBaseOam_32x32, gSurfablePokemonAnimTable, gSurfingOverworldPicTable_Mantine,    gDummySpriteAffineAnimTable, UpdateSurfMonOverlay},
    {0xFFFF, PAL_TAG_KINGDRA_SURF,    &gObjectEventBaseOam_32x32, gSurfablePokemonAnimTable, gSurfingOverworldPicTable_Kingdra,    gDummySpriteAffineAnimTable, UpdateSurfMonOverlay},
    {0xFFFF, PAL_TAG_MILTANK_SURF,    &gObjectEventBaseOam_32x32, gSurfablePokemonAnimTable, gSurfingOverworldPicTable_Miltank,    gDummySpriteAffineAnimTable, UpdateSurfMonOverlay},
    {0xFFFF, PAL_TAG_SUICUNE_SURF,    &gObjectEventBaseOam_32x32, gSurfablePokemonAnimTable, gSurfingOverworldPicTable_Suicune,    gDummySpriteAffineAnimTable, UpdateSurfMonOverlay},
    {0xFFFF, PAL_TAG_TYRANITAR_SURF,  &gObjectEventBaseOam_32x32, gSurfablePokemonAnimTable, gSurfingOverworldPicTable_Tyranitar,  gDummySpriteAffineAnimTable, UpdateSurfMonOverlay},
    {0xFFFF, PAL_TAG_LUGIA_SURF,      &gObjectEventBaseOam_64x64, gSurfablePokemonAnimTable, gSurfingOverworldPicTable_Lugia,      gDummySpriteAffineAnimTable, UpdateSurfMonOverlay},
// Gen III Pokemon
    {0xFFFF, PAL_TAG_MUDKIP_SURF,    &gObjectEventBaseOam_32x32, gSurfablePokemonAnimTable, gSurfingOverworldPicTable_Mudkip,    gDummySpriteAffineAnimTable, UpdateSurfMonOverlay},
    {0xFFFF, PAL_TAG_MARSHTOMP_SURF, &gObjectEventBaseOam_32x32, gSurfablePokemonAnimTable, gSurfingOverworldPicTable_Marshtomp, gDummySpriteAffineAnimTable, UpdateSurfMonOverlay},
    {0xFFFF, PAL_TAG_SWAMPERT_SURF,  &gObjectEventBaseOam_32x32, gSurfablePokemonAnimTable, gSurfingOverworldPicTable_Swampert,  gDummySpriteAffineAnimTable, UpdateSurfMonOverlay},
    {0xFFFF, PAL_TAG_ZIGZAGOON_SURF, &gObjectEventBaseOam_32x32, gSurfablePokemonAnimTable, gSurfingOverworldPicTable_Zigzagoon, gDummySpriteAffineAnimTable, UpdateSurfMonOverlay},
    {0xFFFF, PAL_TAG_LINOONE_SURF,   &gObjectEventBaseOam_32x32, gSurfablePokemonAnimTable, gSurfingOverworldPicTable_Linoone,   gDummySpriteAffineAnimTable, UpdateSurfMonOverlay},
    {0xFFFF, PAL_TAG_LOTAD_SURF,     &gObjectEventBaseOam_32x32, gSurfablePokemonAnimTable, gSurfingOverworldPicTable_Lotad,     gDummySpriteAffineAnimTable, UpdateSurfMonOverlay},
    {0xFFFF, PAL_TAG_LOMBRE_SURF,    &gObjectEventBaseOam_32x32, gSurfablePokemonAnimTable, gSurfingOverworldPicTable_Lombre,    gDummySpriteAffineAnimTable, UpdateSurfMonOverlay},
    {0xFFFF, PAL_TAG_LUDICOLO_SURF,  &gObjectEventBaseOam_32x32, gSurfablePokemonAnimTable, gSurfingOverworldPicTable_Ludicolo,  gDummySpriteAffineAnimTable, UpdateSurfMonOverlay},
    {0xFFFF, PAL_TAG_PELIPPER_SURF,  &gObjectEventBaseOam_32x32, gSurfablePokemonAnimTable, gSurfingOverworldPicTable_Pelipper,  gDummySpriteAffineAnimTable, UpdateSurfMonOverlay},
    {0xFFFF, PAL_TAG_EXPLOUD_SURF,   &gObjectEventBaseOam_32x32, gSurfablePokemonAnimTable, gSurfingOverworldPicTable_Exploud,   gDummySpriteAffineAnimTable, UpdateSurfMonOverlay},
    {0xFFFF, PAL_TAG_MAKUHITA_SURF,  &gObjectEventBaseOam_32x32, gSurfablePokemonAnimTable, gSurfingOverworldPicTable_Makuhita,  gDummySpriteAffineAnimTable, UpdateSurfMonOverlay},
    {0xFFFF, PAL_TAG_HARIYAMA_SURF,  &gObjectEventBaseOam_32x32, gSurfablePokemonAnimTable, gSurfingOverworldPicTable_Hariyama,  gDummySpriteAffineAnimTable, UpdateSurfMonOverlay},
    {0xFFFF, PAL_TAG_AZURILL_SURF,   &gObjectEventBaseOam_32x32, gSurfablePokemonAnimTable, gSurfingOverworldPicTable_Azurill,   gDummySpriteAffineAnimTable, UpdateSurfMonOverlay},
    ...
    {0xFFFF, PAL_TAG_CRAWDAUNT_SURF, &gObjectEventBaseOam_32x32, gSurfablePokemonAnimTable, gSurfingOverworldPicTable_Crawdaunt, gDummySpriteAffineAnimTable, UpdateSurfMonOverlay},
    {0xFFFF, PAL_TAG_FEEBAS_SURF,    &gObjectEventBaseOam_32x32, gSurfablePokemonAnimTable, gSurfingOverworldPicTable_Feebas,    gDummySpriteAffineAnimTable, UpdateSurfMonOverlay},
    {0xFFFF, PAL_TAG_MILOTIC_SURF,   &gObjectEventBaseOam_32x32, gSurfablePokemonAnimTable, gSurfingOverworldPicTable_Milotic,   gDummySpriteAffineAnimTable, UpdateSurfMonOverlay},
    {0xFFFF, PAL_TAG_SPHEAL_SURF,    &gObjectEventBaseOam_32x32, gSurfablePokemonAnimTable, gSurfingOverworldPicTable_Spheal,    gDummySpriteAffineAnimTable, UpdateSurfMonOverlay},
    {0xFFFF, PAL_TAG_SEALEO_SURF,    &gObjectEventBaseOam_32x32, gSurfablePokemonAnimTable, gSurfingOverworldPicTable_Sealeo,    gDummySpriteAffineAnimTable, UpdateSurfMonOverlay},
    {0xFFFF, PAL_TAG_WALREIN_SURF,   &gObjectEventBaseOam_32x32, gSurfablePokemonAnimTable, gSurfingOverworldPicTable_Walrein,   gDummySpriteAffineAnimTable, UpdateSurfMonOverlay},
    {0xFFFF, PAL_TAG_CLAMPERL_SURF,  &gObjectEventBaseOam_32x32, gSurfablePokemonAnimTable, gSurfingOverworldPicTable_Clamperl,  gDummySpriteAffineAnimTable, UpdateSurfMonOverlay},
    {0xFFFF, PAL_TAG_HUNTAIL_SURF,   &gObjectEventBaseOam_32x32, gSurfablePokemonAnimTable, gSurfingOverworldPicTable_Huntail,   gDummySpriteAffineAnimTable, UpdateSurfMonOverlay},
    {0xFFFF, PAL_TAG_GOREBYSS_SURF,  &gObjectEventBaseOam_32x32, gSurfablePokemonAnimTable, gSurfingOverworldPicTable_Gorebyss,  gDummySpriteAffineAnimTable, UpdateSurfMonOverlay},
    {0xFFFF, PAL_TAG_RELICANTH_SURF, &gObjectEventBaseOam_32x32, gSurfablePokemonAnimTable, gSurfingOverworldPicTable_Relicanth, gDummySpriteAffineAnimTable, UpdateSurfMonOverlay},
    {0xFFFF, PAL_TAG_LUVDISC_SURF,   &gObjectEventBaseOam_32x32, gSurfablePokemonAnimTable, gSurfingOverworldPicTable_Luvdisc,   gDummySpriteAffineAnimTable, UpdateSurfMonOverlay},
    {0xFFFF, PAL_TAG_LATIAS_SURF,    &gObjectEventBaseOam_32x32, gSurfablePokemonAnimTable, gSurfingOverworldPicTable_Latias,    gDummySpriteAffineAnimTable, UpdateSurfMonOverlay},
